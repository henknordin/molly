...
class CFormElement implements ArrayAccess
{
  ...
  public function __construct($name, $attributes=array())
  {
    ...
    if(is_callable('CMolly::Instance()'))
    {
      $this->characterEncoding = CMolly::Instance()->config['character_encoding'];
    }
    else
    {
...
class CForm implements ArrayAccess {
   ...
   */
  public function GetHTML($options=array(), $start=null) {
  		...
  		$defaults = array(
      'start'          => $start,  // Only return the start of the form element
