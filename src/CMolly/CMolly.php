<?php
/**
* Main class for Molly, holds everything.
*
* @package MollyCore
*/
class CMolly implements ISingleton
{
			/**
			* Members
			*/
			...
			*/
			protected function __construct()
			{
					...
					// include the site specific config.php and create a ref to $my to be used by config.php
					$my = &$this;
					require(MOLLY_SITE_PATH.'/config.php');
			...
			* @return CMolly The instance of this class.
			*/
			public static function Instance()
			{
					if(self::$instance == null)
					{
							self::$instance = new CMolly();
					}
			...
			*/
			public function ThemeEngineRender()
			{
					...
					$themePath = MOLLY_INSTALL_PATH . '/' . $this->config['theme']['path'];
					...
					{
							$parentPath = MOLLY_INSTALL_PATH . '/' . $this->config['theme']['parent'];
							$parentUrl	= $this->request->base_url . $this->config['theme']['parent'];
					}
    
					// Add stylesheet name to the $my->data array
					$this->data['stylesheet'] = $this->config['theme']['stylesheet'];
					
					// Make the theme urls available as part of $my
					...
					include(MOLLY_INSTALL_PATH . '/themes/functions.php');
			...
			*/
			...
			/**
			* Draw HTML for a menu defined in $my->config['menus'].
			*
