...
class CMModules extends CObject
{
		...
		* Properties
		*/
		private $mollyCoreModules = array('CMolly', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
		private $mollyCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CTextFilter');
		...
		*/
		private function GetDetailsOfModule($module)
		{
				...
				if(class_exists($module))
				{
						...
						$details['isMollyCore'] = in_array($rc->name, $this->mollyCoreModules);
						$details['isMollyCMF'] = in_array($rc->name, $this->mollyCMFModules);
