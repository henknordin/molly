...
class CMContent extends CObject implements IHasSQL, ArrayAccess, IModule
{
		...
		*/
		public function GetFilteredData()
		{
				...
				return $textFilter->Filter($this['data'], array($this['filter']));
		}
}
