...
function autoload($aClassName)
{
		...
		$file1 = MOLLY_SITE_PATH . $classFile;
		$file2 = MOLLY_INSTALL_PATH . $classFile;
		if(is_file($file1))
		{
				require_once($file1);
		}
...
{
		echo "Molly: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
{
		return htmlentities($str, $flags, CMolly::Instance()->config['character_encoding']);
}
